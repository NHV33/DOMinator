...
function renderEditor(_targetElement) {
  ...
  function renderCssGui() {
    ...
    const cssInputFields = [
      ...
      { propName: 'width', label: 'Width', dom: { tag: 'input', type: 'range' } },
      { propName: 'height', label: 'Height', dom: { tag: 'input', type: 'range' } },
      { propName: 'padding', label: 'Padding', dom: { tag: 'input', type: 'range' } },
      { propName: 'margin', label: 'Margin', dom: { tag: 'input', type: 'range' } },
